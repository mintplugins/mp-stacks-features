 ...
 */
function mp_stacks_features_ajax_admin_scripts( $scripts, $metabox_id ){
	
	if ( $metabox_id != 'mp_stacks_features_metabox' ){
		return $scripts;	
	}

	//Enqueue Admin JS
	$scripts['mp_stacks_features_js'] = plugins_url( 'js/features-admin.js?ver=' . MP_STACKS_FEATURES_VERSION, dirname( __FILE__ ) );
	
	return $scripts;

}
add_filter( 'mp_core_metabox_ajax_admin_js_scripts', 'mp_stacks_features_ajax_admin_scripts', 10, 2 );
 ...
 */
function mp_stacks_features_ajax_admin_css( $stylesheets, $metabox_id ){
	...
	$stylesheets['fontawesome'] = plugins_url( '/fonts/font-awesome-4.0.3/css/font-awesome.css?ver=' . MP_STACKS_FEATURES_VERSION, dirname( __FILE__ ) );
	
	//Enqueue Admin CSS
	$stylesheets['mp_stacks_admin_features_css'] = plugins_url( 'css/admin-features.css?ver=' . MP_STACKS_FEATURES_VERSION, dirname( __FILE__ ) );
	
	return $stylesheets;

}
add_filter( 'mp_core_metabox_ajax_admin_css_stylesheets', 'mp_stacks_features_ajax_admin_css', 10, 2 );